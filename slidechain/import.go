...
func (c *Custodian) buildImportTx(
	amount, expMS int64,
	assetXDR, recipPubkey, nonceHash []byte,
) ([]byte, error) {
...
func (c *Custodian) doImport(ctx context.Context, nonceHash []byte, amount int64, assetXDR, recip []byte, expMS int64) error {
	...
	importTxBytes, err := c.buildImportTx(amount, expMS, assetXDR, recip, nonceHash)
	if err != nil {
	...
	log.Printf("printing import tx: %x", importTx.Program)
