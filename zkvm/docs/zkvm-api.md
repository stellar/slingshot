...
* `Predicate::Key` is a _witness type_ representing a signing key for [`signid`](zkvm-spec.md#signid), [`signpin`](zkvm-spec.md#signpin) and [`signtx`](zkvm-spec.md#signtx) instructions.
